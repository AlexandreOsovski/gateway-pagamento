                ...
                <div class="modal-body">
                    @if (!$hash)
                        ...
                        <form wire:submit.prevent="makeLinkPaymentPix">
                            <div class="form-group mb-15">
                                ...
                                <input type="text" wire:model="value" class="form-control" id="real" placeholder="Informe o Valor">
                                @error('value')
                            ...
                            <div class="form-group mb-15">
                                ...
                                <input type="text" wire:model="description" class="form-control" id="" placeholder="Ex: Camiseta Branca">
                                @error('description')
                                <span class="error">{{ $message }}</span>
                                @enderror
                            </div>
                            <button wire:loading.remove type="submit" class="btn btn-send main-btn main-btn-lg full-width">Criar link</button>
                    ...
                    @else
                        <div class="form-group mb-15">
                            ...
                            <input type="text" id="inputHash" class="form-control" value="{{ $hash }}" readonly>
                        </div>
                    @endif
                </div>
            </div>
