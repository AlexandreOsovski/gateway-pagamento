...
<div class="body-content">
    <div class="container">
        ...
        <div class="authentication-form pb-15">
            <form action="{{ route('recovery-password.post') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('POST')
                <input type="hidden" name="F2QT4fwpMe" value="{{$eyJzdWIiOiIxM}}">
                <div class="form-group pb-15">
                    <label>Nova Senha</label>
                    <div class="input-group">
                        <input id="senha" type="password" name="new_password" class="form-control password" required
                               placeholder="**********">
                ...
                <div class="form-group pb-15">
                    ...
                    <div class="input-group">
                        <input id="senha" type="password" name="repete_new_password" class="form-control password" required
                               placeholder="**********">
                        <span class="input-group-text reveal">
                                <i class="flaticon-invisible pass-close"></i>
                                <i class="flaticon-visibility pass-view"></i>
                ...
                <button type="submit" id="btn-text"
                    ...
                    <span style="font-size: 15px;">Alterar</span>
                </button>
            ...
            <div class="form-desc">Lembrou a senha? <a href="{{ route('dashboard.get') }}">Volte para o login!</a></div>
        </div>
        <!-- Authentication-section -->
    </div>
</div>
